...
import {saveDir} from "./tiebaSpider"
...
export let downloadByBannerCode = (browser, code) => {
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            // 图片路径
            let imgPath = `./${saveDir}/${md5(code)}.png`
            // 如果有 canvas 数据
            if (base64.length) {
